#ifndef __lint
static char rcsid[] = "@(#) $Header: /home/deyke/tmp/cvs/tcp/convers/conversd.c,v 2.52 1993-09-01 16:00:00 deyke Exp $";
#endif
...
static void name_command(struct link *lp)
{
  ...
  lp->l_user = up;
  lp->l_stime = currtime;
  sprintf(buffer, "conversd @ %s $Revision: 2.52 $  Type /HELP for help.\n", my.h_name);
  send_string(lp, buffer);
  up->u_oldchannel = up->u_channel;
