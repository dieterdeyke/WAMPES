/* @(#) $Header: /home/deyke/tmp/cvs/tcp/src/hpux.h,v 1.12 1992-09-05 08:15:57 deyke Exp $ */
...
void on_death __ARGS((pid_t pid, void (*fnc )__ARGS ((void *)), void *arg));
void off_death __ARGS((pid_t pid));
