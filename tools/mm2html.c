#ifndef __lint
static const char rcsid[] = "@(#) $Header: /home/deyke/tmp/cvs/tcp/tools/mm2html.c,v 1.14 1996-04-08 13:19:42 deyke Exp $";
#endif
...
static void dot_PS(int argc, char **argv)
{
  ...
  sprintf(buf,
	  ...
	  "pnmcrop -quiet | "
	  "ppmtogif -quiet -transparent rgb:ffff/ffff/ffff > %s",
	  filename);
